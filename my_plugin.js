...
function __wbg_adapter_14(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h161bda1e1e411cf1(arg0, arg1);
}

/**
*/
export function my_plugin_function() {
    wasm.my_plugin_function();
}
...
function getImports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_log_3d7af6d10ad0ac03 = function(arg0, arg1) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('my_plugin_bg.wasm', import.meta.url);
    }
    const imports = getImports();
